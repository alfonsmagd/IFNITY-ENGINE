...
namespace D3D12
{
	...
	D3D12PipelineBuilder& D3D12PipelineBuilder::setFillMode( D3D12_FILL_MODE mode )
	{
		psoDesc_.RasterizerState.FillMode = mode;
		return *this;
	}

	D3D12PipelineBuilder& D3D12PipelineBuilder::setCullMode( D3D12_CULL_MODE mode )
	{
		psoDesc_.RasterizerState.CullMode = mode;
		return *this;
	}

	D3D12PipelineBuilder& D3D12PipelineBuilder::setFrontCounterClockwise( BOOL frontCCW )
	{
		psoDesc_.RasterizerState.FrontCounterClockwise = frontCCW;
		return *this;
	}
