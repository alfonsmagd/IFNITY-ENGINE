...
namespace Vulkan
{
	...
	constexpr UsageMapping usageMappings[] = {
		...
		{ BufferType::UNIFORM_BUFFER, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_KHR }
	...
	*/
	...
	{ rhi::Format::R32G32_FLOAT, VK_FORMAT_R32G32_SFLOAT },
